// src/services/cms/contentfulStore.ts

import type { Locale } from '~/services/core/locale'
import type { StoredLocalizedBlock, ContentBlock } from './internal'
/**
 * Emmagatzematge in-memory per al “Contentful” local.
 *
 * IMPORTANT:
 * - Manté EXACTAMENT la mateixa estructura que tenies als MOCK_:
 *   slug -> locale -> bloc
 */

/**
 * Contingut “general” (hero, about, blog, etc.).
 *
 * Abans: MOCK_CONTENT
 */
export const CONTENTFUL_CONTENT_STORE: Record<
  string,
  Record<Locale, StoredLocalizedBlock>
> = {
  'homepage-hero': {
    ca: {
 ...
 *
 * Abans: LEGAL_MOCK_CONTENT
 */
export const CONTENTFUL_LEGAL_STORE: Record<
  string,
  Record<Locale, ContentBlock>
> = {
